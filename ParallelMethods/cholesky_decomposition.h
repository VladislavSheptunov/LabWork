...
#ifndef PARALLELMETHODS_CHOLESKY_DECOMPOSITION_H
#define PARALLELMETHODS_CHOLESKY_DECOMPOSITION_H
                                                   ...
                                                   int begin_i_A22, int begin_j_A22, int total_len_A22)
{
    double *L21_L21T = NULL,
            *L21T = (double*)malloc((r * (n - r)) * sizeof(double));
#pragma omp parallel sections
    {
#pragma omp section
        {
            L21_L21T = init_matrix((size_t)(n - r));
        }
#pragma omp section
        {
...
#endif //PARALLELMETHODS_CHOLESKY_DECOMPOSITION_H
